...
storiesOf('ModalWrapper', module).addWithInfo('transactional modal', "\n      Transactional modals are used to validate user decisions or to gain secondary confirmation from the user.\n    ", function () {
  ...
  }, "Transactional modals are used to validate user decisions os to gain secondary confirmation from the user. Typically, the modal requests either a 'yes' or 'no' response."), React.createElement("p", {
    className: "bx--modal-content__text"
