...
storiesOf('DatePicker', module).addWithInfo('simple and short', "\n      A simple Date Picker consists of an input field and no calendar.\n    ", function () {
  return React.createElement(DatePicker, _extends({}, datePickerProps, {
    short: true,
    datePickerType: "simple"
  }), React.createElement(DatePickerInput, _extends({}, datePickerInputProps, simpleShortDatePickerInputProps)));
}).addWithInfo('simple and normal', "\n      A simple Date Picker consists of an input field and no calendar.\n    ", function () {
  return React.createElement(DatePicker, {
    id: "date-picker",
    datePickerType: "simple"
  }, React.createElement(DatePickerInput, datePickerInputProps));
