...
function (_Component) {
  ...
  function DetailPageHeader(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DetailPageHeader).call(this, props));
    ...
    if (process.env.NODE_ENV !== "production") {
      process.env.NODE_ENV !== "production" ? warning(didWarnAboutDeprecation, 'Accessing the `DetailPageHeader` component from the ' + '`carbon-components-react` package is deprecated. Use the ' + '`carbon-addons-cloud-react` package instead.') : void 0;
