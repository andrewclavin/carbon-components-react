...
function (_Component3) {
  ...
  function ToastNotification() {
    ...
    _defineProperty(_assertThisInitialized(_this), "useIconName", function (kindProp) {
...
function (_Component4) {
  ...
  function InlineNotification() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(InlineNotification)).call.apply(_getPrototypeOf3, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_this2), "state", {
      open: true
    });

    _defineProperty(_assertThisInitialized(_this2), "handleCloseButtonClick", function (evt) {
      _this2.setState({
        open: false
      });
    ...
    _defineProperty(_assertThisInitialized(_this2), "useIconName", function (kindProp) {
      var isSuccess = kindProp === 'success';
      return isSuccess ? 'checkmark--glyph' : "".concat(kindProp, "--glyph");
    });
...
function (_Component5) {
  ...
  function Notification() {
    ...
    _this3 = _possibleConstructorReturn(this, (_getPrototypeOf4 = _getPrototypeOf(Notification)).call.apply(_getPrototypeOf4, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this3), "useIconName", function (kindProp) {
      var isSuccess = kindProp === 'success';
      return isSuccess ? 'checkmark--glyph' : "".concat(kindProp, "--glyph");
    });
