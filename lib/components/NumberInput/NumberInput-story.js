...
(0, _react2.storiesOf)('NumberInput', module).addWithInfo('enabled', "\n      ".concat(introText, "\n      The example below shows an enabled Number Input component.\n    "), function () {
  return _react.default.createElement(_NumberInput.default, numberInputProps);
  ...
  return _react.default.createElement(_NumberInput.default, _extends({}, numberInputProps, {
    invalid: true
  }));
