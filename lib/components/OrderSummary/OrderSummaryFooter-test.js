...
describe('OrderSummaryFooter', function () {
  describe('Renders as expected', function () {
    var orderSummaryFooter = (0, _enzyme.mount)(_react.default.createElement(_OrderSummary.OrderSummaryFooter, {
    ...
    it('should render children as expected', function () {
      expect(orderSummaryFooter.find(_Link.default).length).toEqual(1);
    });
  });
});