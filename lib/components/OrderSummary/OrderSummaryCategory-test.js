...
describe('OrderSummaryCategory', function () {
  describe('Renders as expected', function () {
    var orderSummaryCategory = (0, _enzyme.shallow)(_react.default.createElement(_OrderSummary.OrderSummaryCategory, {
      className: "some-class",
      categoryText: "Category 1"
    }, _react.default.createElement(_OrderSummary.OrderSummaryListItem, null), _react.default.createElement(_OrderSummary.OrderSummaryListItem, null), _react.default.createElement(_OrderSummary.OrderSummaryListItem, null)));
