...
describe('Module', function () {
  describe('Renders as expected', function () {
    var testModule = (0, _enzyme.shallow)(_react.default.createElement(_Module.Module, {
      className: "extra-class"
    }, _react.default.createElement(_Module.ModuleBody, null, "Body")));
  ...
  describe('ModuleBody', function () {
    describe('Renders as expected', function () {
      var moduleBody = (0, _enzyme.shallow)(_react.default.createElement(_Module.ModuleBody, {
        className: "extra-class",
        centered: true
      }, "Body"));
