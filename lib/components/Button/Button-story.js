...
(0, _react2.storiesOf)('Buttons', module).addWithInfo('Primary Buttons', "\n      Buttons are used to initialize an action, either in the background or\n      foreground of an experience.\n\n      Primary buttons should be used for the principle call to action\n      on the page. Modify the behavior of the button by changing its event properties.\n\n      Small buttons may be used when there is not enough space for a\n      regular sized button. This issue is most found in tables. Small button should have three words\n      or less.\n\n      The example below shows Primary Button component .\n    ", function () {
  return _react.default.createElement("div", null, _react.default.createElement(_Button.default, _extends({}, buttonEvents, {
    className: "some-class"
  }), "Primary button"), "\xA0", _react.default.createElement(_Button.default, _extends({}, buttonEvents, {
    href: "#",
    className: "some-class"
  }), "Primary link"), "\xA0");
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_Button.default, _extends({
    ...
    className: "some-class"
  }), "Secondary button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    kind: "secondary"
  }, buttonEvents, {
    href: "#",
    className: "some-class"
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_Button.default, _extends({
    ...
    className: "some-class"
  }), "Small primary button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    small: true
  }, buttonEvents, {
    kind: "secondary"
  }), "Small secondary Button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    small: true
  }, buttonEvents, {
    kind: "ghost",
    icon: "add--glyph",
    iconDescription: "Add"
  }), "Small ghost Button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    small: true
  }, buttonEvents, {
    kind: "danger"
  }), "Small danger Button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    small: true
  }, buttonEvents, {
    href: "#",
    className: "some-class"
  ...
  }, buttonEvents), "Primary with icon"), "\xA0", _react.default.createElement(_Button.default, _extends({
    kind: "secondary",
    icon: "search--glyph",
    iconDescription: "Search"
  }, buttonEvents), "Secondary with icon"), "\xA0", _react.default.createElement(_Button.default, _extends({
    small: true,
    kind: "primary",
    icon: "search--glyph",
    iconDescription: "Search"
  }, buttonEvents), "Small primary with icon"), "\xA0", _react.default.createElement(_Button.default, _extends({
    small: true,
    kind: "secondary",
    icon: "search--glyph",
    iconDescription: "Search"
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_Button.default, _extends({
    ...
    icon: "add--glyph",
    iconDescription: "Add"
  }, buttonEvents), "Ghost button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    kind: "ghost",
    href: "#",
    className: "some-class",
    icon: "add--glyph",
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_Button.default, _extends({
    ...
    className: "some-class"
  }), "Danger button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    kind: "danger"
  }, buttonEvents, {
    href: "#",
    className: "some-class"
  }), "Danger link"), "\xA0", _react.default.createElement(_Button.default, _extends({
    kind: "danger--primary"
  }, buttonEvents, {
    className: "some-class"
  }), "Danger Primary button"), "\xA0", _react.default.createElement(_Button.default, _extends({
    kind: "danger--primary"
  }, buttonEvents, {
    href: "#",
    className: "some-class"
  ...
  return _react.default.createElement("div", null, _react.default.createElement(_Button.default, _extends({
    ...
    className: "some-class"
  }), "Secondary button"), _react.default.createElement(_Button.default, _extends({
    kind: "primary"
  }, buttonEvents, {
    className: "some-class"
  }), "Primary button"));
