...
var TableBatchActions = function TableBatchActions(_ref) {
  ...
  }, _react.default.createElement("span", null, totalSelected), ' ', totalSelected > 1 ? t('carbon.table.batch.items.selected') : t('carbon.table.batch.item.selected')), _react.default.createElement("button", {
