...
describe('StructuredListInput', function () {
  describe('Renders as expected', function () {
    ...
    it('Should render unique id with multiple inputs when no id prop is given', function () {
      var wrapper1 = (0, _enzyme.shallow)(_react.default.createElement(_StructuredList.StructuredListInput, {
        className: "extra-class"
      }));
      var wrapper2 = (0, _enzyme.shallow)(_react.default.createElement(_StructuredList.StructuredListInput, {
        className: "extra-class"
      }));
