...
describe('InteriorLeftNavList', function () {
  describe('Renders as expected', function () {
    var openList = (0, _enzyme.shallow)(_react.default.createElement(_InteriorLeftNavList.default, {
    ...
    var closedList = (0, _enzyme.shallow)(_react.default.createElement(_InteriorLeftNavList.default, null, _react.default.createElement(_InteriorLeftNavItem.default, {
      href: ""
    }, _react.default.createElement("a", {
      href: "http://www.carbondesignsystem.com"
    }, "test-title"))));
    var expectedChildrenList = (0, _enzyme.shallow)(_react.default.createElement(_InteriorLeftNavList.default, null, _react.default.createElement(_InteriorLeftNavItem.default, {
      href: "",
      className: "test-child"
    }, _react.default.createElement("a", {
      href: "http://www.carbondesignsystem.com"
    }, "test-title")), _react.default.createElement(_InteriorLeftNavItem.default, {
      href: "",
      className: "test-child"
    }, _react.default.createElement("a", {
      href: "http://www.carbondesignsystem.com"
    ...
    it('should have children with tab index of zero when open', function () {
      expect(openList.find(_InteriorLeftNavItem.default).props().tabIndex).toEqual(0);
    });
    it('should have children with tab index of negative one when closed', function () {
      expect(closedList.find(_InteriorLeftNavItem.default).props().tabIndex).toEqual(-1);
    });
    ...
    it('should use correct icon', function () {
      var icon = openList.find(_Icon.default);
  ...
  describe('Check that functions passed in as props are called', function () {
    ...
    var wrapper = (0, _enzyme.mount)(_react.default.createElement(_InteriorLeftNavList.default, {
  ...
  describe('calling the close method should close the list when open', function () {
    var wrapper = (0, _enzyme.shallow)(_react.default.createElement(_InteriorLeftNavList.default, {
      open: true
    }));
  ...
  describe('actions', function () {
    var list = (0, _enzyme.mount)(_react.default.createElement(_InteriorLeftNavList.default, {
      title: "test-title"
    }, _react.default.createElement(_InteriorLeftNavItem.default, {
      href: ""
    }, _react.default.createElement("a", {
