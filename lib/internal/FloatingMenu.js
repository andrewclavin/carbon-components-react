...
function (_React$Component) {
  ...
  _createClass(FloatingMenu, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var invokeOnPlace = function invokeOnPlace() {
        var onPlace = _this2.props.onPlace;

        if (_this2._placeInProgress && _this2.state.floatingPosition && typeof onPlace === 'function') {
          onPlace(_this2._menuBody);
          _this2._placeInProgress = false;
        }
      };

      if (!hasCreatePortal) {
        _reactDom.default.render(this._getChildrenWithProps(), this._menuContainer, invokeOnPlace);
      } else {
    ...
    value: function componentDidMount() {
      ...
      if (!hasCreatePortal) {
        ...
        var childrenWithProps = _react.default.cloneElement(this.props.children, {
          style: style
        });

        _reactDom.default.render(childrenWithProps, this._menuContainer, function () {
          _this3._placeInProgress = true;
          _this3._menuBody = _this3._menuContainer.firstChild;

          _this3._updateMenuSize();

          _reactDom.default.render(_this3._getChildrenWithProps(), _this3._menuContainer, function () {
            menuRef && menuRef(_this3._menuBody);
          });
        });
      } else {
    ...
    value: function render() {
      if (typeof document !== 'undefined' && hasCreatePortal) {
        return _reactDom.default.createPortal(this._getChildrenWithProps(), this.el);
      }
